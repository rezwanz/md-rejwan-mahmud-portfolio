// MIRROR of src/data/content.ts — do not edit this copy independently.
// This file exists only for planning/reference purposes. Whenever
// src/data/content.ts changes, re-sync this file from it (or delete this
// file and point readers at the real source) so the two never drift and
